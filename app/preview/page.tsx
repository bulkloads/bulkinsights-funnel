...
/* ── Inline BulkLoads wordmark ─────────────────────────────── */
function BulkLoadsWordmark({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
  const cls =
    size === "lg"
      ? "text-3xl"
      : size === "sm"
      ...
      : "text-2xl";
  return (
    <span className={`font-display font-extrabold tracking-tight leading-none ${cls}`}>
      <span style={{ color: "#95c93d" }}>bulk</span>
      <span style={{ color: "#f47d01" }}>Loads</span>
    </span>
  );
}
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-xl p-3 text-center" style={{ border: "1px solid rgba(149,201,61,0.3)", background: "rgba(149,201,61,0.06)" }}>
            <div className="text-[9px] font-mono uppercase tracking-wider" style={{ color: "#95c93d" }}>Low</div>
          ...
          <div className="rounded-xl p-3 text-center" style={{ border: "1px solid rgba(244,125,1,0.4)", background: "rgba(244,125,1,0.1)" }}>
            <div className="text-[9px] font-mono uppercase tracking-wider" style={{ color: "#f47d01" }}>High</div>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-1">
            {["3M","6M","9M","12M"].map(t => (
              <button key={t} className="text-[9px] px-2 py-1 rounded font-mono"
                style={t === "12M" ? { background: "#f47d01", color: "#0c1d2b", fontWeight: 700 } : { background: "rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)" }}>
                {t}
              </button>
            ))}
          </div>
    ...
    <main className="min-h-screen" style={{ background: "#0c1d2b" }}>
      ...
      <header className="relative border-b sticky top-0 z-40" style={{ background: "rgba(12,29,43,0.97)", borderColor: "rgba(255,255,255,0.06)", backdropFilter: "blur(12px)" }}>
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <BulkLoadsWordmark size="md" />
            <div className="h-5 w-px" style={{ background: "rgba(255,255,255,0.15)" }} />
            <span className="text-[11px] font-mono uppercase tracking-[0.2em]" style={{ color: "#f47d01" }}>Bulk Insights</span>
          </div>
          <div className="hidden sm:flex items-center gap-5">
            <span className="text-xs text-white/30 font-mono">14 years of real bulk freight data</span>
            <div className="flex items-center gap-1.5">
              <span className="h-1.5 w-1.5 rounded-full animate-pulse" style={{ background: "#95c93d" }} />
              <span className="text-[10px] font-mono uppercase tracking-widest" style={{ color: "#95c93d" }}>Live Market Data</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="relative pt-20 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.25em] mb-6 rounded-full px-4 py-2" style={{ color: "#f47d01", background: "rgba(244,125,1,0.1)", border: "1px solid rgba(244,125,1,0.2)" }}>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <div className="inline-flex items-center gap-2 font-bold text-sm px-6 py-3.5 rounded-xl cursor-pointer transition-colors"
              style={{ background: "#f47d01", color: "#0c1d2b", boxShadow: "0 8px 24px rgba(244,125,1,0.3)" }}>
            ...
            <div className="text-xs font-mono text-white/25">No commitment · 30 minutes · See your lanes live</div>
          </div>
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 max-w-lg mx-auto">
            {[
              ...
              <div key={num} className="text-center">
                <div className="font-display font-bold text-2xl" style={{ color: "#f47d01" }}>{num}</div>
      ...
      <section className="py-16 relative">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <div className="text-[10px] font-mono uppercase tracking-[0.25em] mb-3" style={{ color: "#f47d01" }}>A Glimpse Inside</div>
            ...
            {features.map((feat, i) => (
              ...
              >
                <div className={i % 2 === 1 ? "lg:col-start-2" : ""}>
                  <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.2em] rounded-full px-3 py-1.5 mb-4"
                    style={{ color: "#f47d01", background: "rgba(244,125,1,0.1)", border: "1px solid rgba(244,125,1,0.2)" }}>
                  ...
                  <p className="leading-relaxed mb-6" style={{ color: "#8aabd0" }}>
                    {feat.description}
                  </p>
                  <div className="flex items-center gap-2 text-sm font-semibold cursor-pointer transition-colors" style={{ color: "#f47d01" }}>
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-8">
          <div className="relative rounded-3xl overflow-hidden shadow-2xl" style={{ border: "1px solid rgba(244,125,1,0.2)", boxShadow: "0 25px 60px rgba(244,125,1,0.08)" }}>
            ...
            <div className="relative p-8 lg:p-14 text-center">
              <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.25em] mb-6" style={{ color: "#f47d01" }}>
                <span className="h-1.5 w-1.5 rounded-full animate-pulse" style={{ background: "#f47d01" }} />
                See It For Yourself
              </div>
              ...
              <div className="mt-12 grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto text-left">
                {perks.map((p) => (
                  <div
                    key={p.title}
                    className="relative p-5 rounded-xl transition-colors group"
                    style={{ background: "rgba(12,29,43,0.5)", border: "1px solid rgba(255,255,255,0.06)" }}
                  >
                ...
                <div className="relative p-6 lg:p-7 rounded-2xl overflow-hidden text-left" style={{ background: "linear-gradient(135deg, rgba(12,29,43,0.9) 0%, rgba(23,51,70,0.7) 100%)", border: "1px solid rgba(244,125,1,0.2)" }}>
                  ...
                  <div className="relative flex flex-col sm:flex-row sm:items-center gap-5">
                    ...
                    <div className="flex-1 min-w-0 text-center sm:text-left">
                      ...
                      <div className="text-xs font-mono mt-0.5" style={{ color: "rgba(244,125,1,0.9)" }}>Growth Architect, Enterprise</div>
      ...
      <footer className="border-t py-8" style={{ borderColor: "rgba(255,255,255,0.05)" }}>
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <BulkLoadsWordmark size="sm" />
            <span className="text-xs text-white/25 font-mono">· Bulk Insights</span>
          </div>
